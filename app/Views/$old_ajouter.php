                ...
                <div class="parent">
                  <div class="div1"> 
                    <div class='addFrais'>
                      ...
                      <form method='post' action='ajoutfrais.php'>
                          ...
                          <button type='submit' name="submit" value="ff">Valider</button>
                      </form>
                    </div>
                  </div>
                  ...
                  <div class="div2">
                    <div class='addFrais'>
                      ...
                      <form method='post' action='ajoutfrais.php'>
                          <input type="text" placeholder="Nom du frais" name="libelle">
                          <input type="date" name="date">
                          <input type="number" placeholder="Prix" name="prix">
                          <button type='submit' name="submit" value="fhf">Valider</button>
                      </form>
                    </div>
                  </div>
                </div>
